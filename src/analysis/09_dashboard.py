...
<title>Inside the Art &amp; Architecture Thesaurus</title>
...
.hero-bg {{
    ...
    background: url('data:image/jpeg;base64,{mills_b64}') center top/contain no-repeat;
...
<div class="hero">
    ...
    <div class="hero-content">
        <h1>Inside the<br><strong>Art &amp; Architecture Thesaurus</strong></h1>
        <p class="tagline">44,225 terms. 12 facets. Centuries of material culture.</p>
        <div class="hero-stats">
            <div class="hero-stat"><div class="num">44,225</div><div class="lbl">Terms</div></div>
            <div class="hero-stat"><div class="num">12</div><div class="lbl">Facets</div></div>
            <div class="hero-stat"><div class="num">334K</div><div class="lbl">Translations</div></div>
            <div class="hero-stat"><div class="num">37K</div><div class="lbl">Descriptions</div></div>
            <div class="hero-stat"><div class="num">11</div><div class="lbl">Max Depth</div></div>
        </div>
    </div>
...
<nav>
    <div class="nav-bar">
        ...
        <a href="#trends" class="nav-link">Trending</a>
        <a href="#depth" class="nav-link">Depth</a>
        <a href="#geography" class="nav-link">Geography</a>
        <a href="#scripts" class="nav-link">Languages</a>
    </div>
</nav>
...
<div class="story">
    ...
    <div class="chapter" id="overview">
        <div class="two-col">
            <div class="col-text">
                ...
                <h2>One third of every term describes a physical object.</h2>
            ...
            <div class="col-chart">
                <div class="chart-wrap" id="chart-facet_donut"></div>
            </div>
        </div>
    </div>
    ...
    <!-- 2 — CENTURIES -->
    <div class="chapter" id="centuries">
        <span class="chapter-label">Through Time</span>
        <h2>The 19th century casts the longest shadow.</h2>
        ...
        <div class="chart-wrap" id="chart-century_heatmap"></div>
    </div>

    <div class="sep"></div>

    <!-- 3 — SUNBURST -->
    <div class="chapter" id="sunburst">
        <span class="chapter-label">The Hierarchy</span>
        <h2 style="max-width:600px;">Click inward. This is how knowledge is organized.</h2>
        ...
        <div class="chart-wrap" id="chart-sunburst"></div>
    </div>

    <div class="sep"></div>

    <!-- 4 — TRENDS -->
    <div class="chapter" id="trends">
        <span class="chapter-label">Trending Terms</span>
        <h2>When was each word at its peak?</h2>
        ...
        <div class="chart-wrap" id="chart-kw_trend"></div>
    </div>

    <div class="sep"></div>

    <!-- 5 — DEPTH -->
    <div class="chapter" id="depth">
        <div class="two-col-reverse">
            <div class="col-text">
                <span class="chapter-label">Depth</span>
                <h2>Some branches run eleven levels deep.</h2>
            ...
            <div class="col-chart">
                <div class="chart-wrap" id="chart-depth_violin"></div>
            </div>
        </div>
    </div>
    ...
    <!-- 6 — GEOGRAPHY -->
    <div class="chapter" id="geography">
        <span class="chapter-label">Geography</span>
        <h2>Asia and Europe, neck and neck.</h2>
        ...
        <div class="chart-wrap" id="chart-geo_time"></div>
    </div>

    <div class="sep"></div>

    <!-- 7 — SCRIPTS -->
    <div class="chapter" id="scripts">
        <div class="two-col">
            <div class="col-text">
                <span class="chapter-label">Languages</span>
                <h2>334,694 names in scripts spanning the globe.</h2>
            ...
            <div class="col-chart">
                <div class="chart-wrap" id="chart-scripts"></div>
            </div>
        </div>
    </div>
